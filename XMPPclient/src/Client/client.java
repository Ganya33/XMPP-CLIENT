...
import Client.Sendmail; //Program used for sending warning message to a particular email id
 
public class client implements MessageListener
{
	String OsName=System.getProperty("os.name");
	String to ="admin@ganya";
    ...
    {
    ConnectionConfiguration config = new ConnectionConfiguration("192.168.110.102");
   ...
   /* Chat chat6 = connection.getChatManager().createChat(to, this);	
	...
	public static void main(String args[]) throws XMPPException, IOException, MalformedObjectNameException, InstanceNotFoundException, ReflectionException
    {
        ...
        String msg;
        c.getipadd();
        ConnectionConfiguration connConfig = new ConnectionConfiguration("192.168.110.102");
